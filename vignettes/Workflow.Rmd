...
Functions of the package [flowTraceR](https://cran.r-project.org/web/packages/flowTraceR/index.html) are incorporated in mpwR for inter-software comparisons. Software outputs are standardized and easily comparable.
