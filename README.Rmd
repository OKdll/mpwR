...
## Applications
The functions of mpwR provide a great foundation to generate customized reports e.g. with RMarkdown or to build shiny apps/dashboards for downstream data analysis. An example for a shiny dashboard is available [here](https://okdll.shinyapps.io/mpwR/). 
